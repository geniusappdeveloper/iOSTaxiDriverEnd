...
//        centerViewController = mainstoryBoard.instantiateViewController(withIdentifier: "welcm_screen") as! welcm_screen
//        let leftViewController = mainstoryBoard.instantiateViewController(withIdentifier: "Side_menu_vc") as! Side_menu_vc
